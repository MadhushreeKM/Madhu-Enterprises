    ...
    updateProductOptions() {
        ...
        const products = {
            'stone': [
                ...
                'Polished Pebbles', 
                'Unpolished Pebbles',
                'Pebble Crushed Chips'
                // 'Multi-color Pebbles' // temporarily removed: out of stock
            ],
            'sand': [
...
function callNow() {
    window.location.href = 'tel:+917760682229';
}
